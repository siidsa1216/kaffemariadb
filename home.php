    ...
    <div class="bigside">
        <div class="container my-5" style="margin:66px;">
            ...
            <div class="container-fluid mt-3">
                <div class="row">
                    <div class="col p-3 m-3 bg-primary text-white">BEVERAGE <br><br>(No. of Beverages Available)</div>
                    <div class="col p-3 m-3 bg-dark text-white">INVENTORY <br><br>(No. of Beverages Available)</div>
